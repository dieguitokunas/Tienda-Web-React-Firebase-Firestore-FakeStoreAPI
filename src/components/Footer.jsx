import { AttachEmail, GitHub, LinkedIn, PhoneAndroid } from "@mui/icons-material";
import './Footer.css'
export function Footer() {
  return (
    <footer className="footer w-full min-h-96 grid max-sm:grid-cols-1 max-md:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 max-md:gap-20 md:gap-10 p-4 place-items-center">
      ...
      <span className="border-[--golden-yellow] w-full h-48 border-r-2 border-b-2 p-2">
                <div className="text-[--white-bone]">
                    ...
                    <p>If you are interesed to know more about my jobs, you can go to my portfolio by <strong className="text-[--golden-yellow]"><a href="">clicking here</a></strong></p>
                    </span>
                </div>
            </span>
      ...
      <span className="border-[--golden-yellow] w-full h-48 border-r-2 border-b-2 p-2">
        <div className="text-[--white-bone] ">
          ...
          <li className="flex gap-2"><PhoneAndroid/>+54-9-11-35049242</li>
          <li className="flex gap-2"><LinkedIn/>Diego Borrás on Linkedin</li>
          <li className="flex gap-2"><GitHub/>dieguitokunas on GitHub</li>
          </ul>
        </div>
      </span>
      <span className="border-[--golden-yellow] w-full h-48 border-l-2 border-t-2 p-2 flex flex-col">
        <ul className="text-[--white-bone]">
          <p className="font-black text-xl border-b-2 border-[--white-bone]">Write me here</p>
